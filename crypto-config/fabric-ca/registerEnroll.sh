...
function createOrg1() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@fabric-ca:7054 --caname ca_org1 --tls.certfiles ${PWD}/crypto-config/fabric-ca/org1/ca-cert.pem
{ set +x; } 2>/dev/null
...
infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@fabric-ca:7054 --caname ca_org1 -M ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/msp --csr.hosts peer0 --tls.certfiles ${PWD}/crypto-config/fabric-ca/org1/ca-cert.pem
...
fabric-ca-client enroll -u https://peer0-org1:peer0PW@fabric-ca:10054 --caname ca_tls -M ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls --enrollment.profile tls --csr.hosts peer0 --tls.certfiles ${PWD}/crypto-config/fabric-ca/tls/ca-cert.pem
 ...
 infoln "Generating the peer1 msp"
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@fabric-ca:7054 --caname ca_org1 -M ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/msp --csr.hosts peer1 --tls.certfiles ${PWD}/crypto-config/fabric-ca/org1/ca-cert.pem
  { set +x; } 2>/dev/null
...
#fabric-ca-client register -d --id.name peer1-org1 --id.secret peer1PW --id.type peer -u https://localhost:10054
  ...
  set -x
  fabric-ca-client enroll -u https://peer1-org1:peer1PW@fabric-ca:10054 --caname ca_tls -M ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/tls --enrollment.profile tls --csr.hosts peer1 --tls.certfiles ${PWD}/crypto-config/fabric-ca/tls/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@fabric-ca:7054 --caname ca_org1 -M ${PWD}/crypto-config/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp --tls.certfiles ${PWD}/crypto-config/fabric-ca/org1/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://org1admin:org1adminpw@fabric-ca:7054 --caname ca_org1 -M ${PWD}/crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp --tls.certfiles ${PWD}/crypto-config/fabric-ca/org1/ca-cert.pem
  { set +x; } 2>/dev/null
...
function createOrg2() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@fabric-ca:8054 --caname ca_org2 --tls.certfiles ${PWD}/crypto-config/fabric-ca/org2/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer2:peer2pw@fabric-ca:8054 --caname ca_org2 -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer2.org2.example.com/msp --csr.hosts peer2 --tls.certfiles ${PWD}/crypto-config/fabric-ca/org2/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer2-org2:peer2PW@fabric-ca:10054 --caname ca_tls -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer2.org2.example.com/tls --enrollment.profile tls --csr.hosts peer2 --tls.certfiles ${PWD}/crypto-config/fabric-ca/tls/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer3:peer3pw@fabric-ca:8054 --caname ca_org2 -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer3.org2.example.com/msp --csr.hosts peer3 --tls.certfiles ${PWD}/crypto-config/fabric-ca/org2/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer3-org2:peer3PW@fabric-ca:10054 --caname ca_tls -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer3.org2.example.com/tls --enrollment.profile tls --csr.hosts peer3 --tls.certfiles ${PWD}/crypto-config/fabric-ca/tls/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@fabric-ca:8054 --caname ca_org2 -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp --tls.certfiles ${PWD}/crypto-config/fabric-ca/org2/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://org2admin:org2adminpw@fabric-ca:8054 --caname ca_org2 -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp --tls.certfiles ${PWD}/crypto-config/fabric-ca/org2/ca-cert.pem
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@fabric-ca:9054 --caname ca_ordererOrg -M ${PWD}/crypto-config/ordererOrganizations/example.com/msp --tls.certfiles ${PWD}/crypto-config/fabric-ca/ordererOrg/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@fabric-ca:9054 --caname ca_ordererOrg -M ${PWD}/crypto-config/ordererOrganizations/example.com/orderers/orderer0.example.com/msp --csr.hosts orderer0 --csr.hosts fabric-ca --tls.certfiles ${PWD}/crypto-config/fabric-ca/ordererOrg/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer0-org:orderer0PW@fabric-ca:10054 --caname ca_tls -M ${PWD}/crypto-config/ordererOrganizations/example.com/orderers/orderer0.example.com/tls --enrollment.profile tls --csr.hosts orderer0 --tls.certfiles ${PWD}/crypto-config/fabric-ca/tls/ca-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@fabric-ca:9054 --caname ca_ordererOrg -M ${PWD}/crypto-config/ordererOrganizations/example.com/users/Admin@example.com/msp --tls.certfiles ${PWD}/crypto-config/fabric-ca/ordererOrg/ca-cert.pem
  { set +x; } 2>/dev/null
