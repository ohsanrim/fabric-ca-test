...
infoln "Stopping network" 
  ...
  docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf crypto-config/fabric-ca/org1/msp crypto-config/fabric-ca/org1/tls-cert.pem crypto-config/fabric-ca/org1/IssuerPublicKey crypto-config/fabric-ca/org1/IssuerRevocationPublicKey crypto-config/fabric-ca/org1/fabric-ca-server.db'
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf crypto-config/fabric-ca/org2/msp crypto-config/fabric-ca/org2/tls-cert.pem crypto-config/fabric-ca/org2/IssuerPublicKey crypto-config/fabric-ca/org2/IssuerRevocationPublicKey crypto-config/fabric-ca/org2/fabric-ca-server.db'
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf crypto-config/fabric-ca/ordererOrg/msp crypto-config/fabric-ca/ordererOrg/tls-cert.pem crypto-config/fabric-ca/ordererOrg/IssuerPublicKey crypto-config/fabric-ca/ordererOrg/IssuerRevocationPublicKey crypto-config/fabric-ca/ordererOrg/fabric-ca-server.db'
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf crypto-config/fabric-ca/tls/msp crypto-config/fabric-ca/tls/tls-cert.pem crypto-config/fabric-ca/tls/IssuerPublicKey crypto-config/fabric-ca/tls/IssuerRevocationPublicKey crypto-config/fabric-ca/tls/fabric-ca-server.db crypto-config/fabric-ca/tls/admin'
